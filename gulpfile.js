...
gulp.task("generateDTS", function(done) {
    ...
    bundleDTS.generateES2015DTS(indexDTSPath, "wonder-fantasy-land/dist/es2015", path.join(distPath, "wdfl.es2015.d.ts"));
    bundleDTS.generateCommonjsDTS(indexDTSPath, "wonder-fantasy-land/dist/commonjs", path.join(distPath, "wdfl.commonjs.d.ts"));
